...
def _render_content(request) -> str:
    ...
    return render_string(request, f"{KEY}/content.html", _ctx())
...
def content(request: Request):
    return render(request, f"{KEY}/content.html", _ctx())
...
def backend_select_modal(request: Request):
    return render(request, f"{KEY}/modals/backend_select.html", dict(
...
def create_modal(backend: str, request: Request):
    return render(request, f"{KEY}/modals/channel.html", dict(
        channel=None,
        channel_id=None,
...
def create_job_modal(request: Request):
    module_sources, scheduler_sources = _split_sources()
    return render(request, f"{KEY}/modals/job.html", dict(
        job=None,
        job_id=None,
